...
import { selecQuickViewProducts} from '../../features/quickView/quickViewSlice';
...
const ProductDetails = ({ product }) => {
  ...
  const inCart = selectCartProducts.find((cartItem) => cartItem.id === product.id);
