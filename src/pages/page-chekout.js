...
import { useGetCartQuery, useGetCartProductQuery } from "../api/cartApi";
              ...
              <div className="col-lg-8 mb-40">
                ...
                <div className="d-flex justify-content-between">
                  <h6 className="text-body">
                    There are{" "}
                    <span className="text-brand">{cartProducts.length}</span>{" "}
              ...
              <div className="col-lg-5">
                <div className="border p-40 cart-totals ml-30 mb-50">
                  ...
                  <div className="table-responsive order_table">
                    ...
                    <table
                      className={
                        cartProducts.length > 0 ? "table no-border" : "d-none"
                      }
                    >
                      <tbody>
                          ...
                          <tr key={i}>
                            ...
                            <td>
                              <h6 className="text-muted pl-20 pr-20">
                                x {filteredQuantities[i].quantity}
                              </h6>
                            </td>
                            <td>
                  ...
                  <a  href="#" className="btn btn-fill-out btn-block mt-30"  onClick={(e) => handleAddOrder()}>
                    Place Order
                  </a>
                </div>
              </div>
